...
export const DELETE_FBPAGE_SUCCESS = 'DELETE_FBPAGE_SUCCESS';
export const DELETE_FBPAGE_FAIL = 'DELETE_FBPAGE_FAIL';
export const RESET_STATUS = 'RESET_STATUS';
export const ASSIGN_AGENT_UPDATE_STATUS = 'ASSIGN_AGENT_UPDATE_STATUS';
export const RESET_GROUP_EDIT = 'RESET_GROUP_EDIT';
export const ADD_DEPTTEAMS = 'ADD_DEPTTEAMS';
export const ADD_FBPAGETEAMS = 'ADD_FBPAGETEAMS';
export const SINGLE_CHAT_FETCH = 'SINGLE_CHAT_FETCH';
export const SINGLE_SESSION_FETCH = 'SINGLE_SESSION_FETCH';
export const RESET_NOTIFICATIONS = 'RESET_NOTIFICATIONS';
export const SHOW_UNREAD_COUNT = 'SHOW_UNREAD_COUNT';
export const FORGOT_PASSWORD_SUCCESS = 'FORGOT_PASSWORD_SUCCESS';
export const FORGOT_PASSWORD_FAIL = 'FORGOT_PASSWORD_FAIL';
export const ADD_LASTMESSAGE_CHAT_SESSION = 'ADD_LASTMESSAGE_CHAT_SESSION';
export const ADD_LASTMESSAGE_FB_SESSION = 'ADD_LASTMESSAGE_FB_SESSION';
export const ADD_UNREAD_COUNT = 'ADD_UNREAD_COUNT';
export const DOWNLOAD_VIDEO_FILE = 'DOWNLOAD_VIDEO_FILE';
