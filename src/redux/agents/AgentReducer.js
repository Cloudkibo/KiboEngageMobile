...
export default (state = INITIAL_STATE, action) => {
  switch (action.type) {
   ...
   case ActionTypes.AGENT_ROLE_UPDATE:
       return {...state,agents:action.payload,statuscode: action.payload,status:action.payload == 200?"Agent role updated successfully":"Something went wrong while updaing agent role."};
