...
export default (state = INITIAL_STATE, action) => {
  switch (action.type) {
    ...
    case ActionTypes.EDIT_TEAM_SUCCESS:
      return { ...state, ...INITIAL_STATE,myteams:state.myteams,teams : state.teams,teamerror: '', teamsuccess: 'Team details updated successfully',teamagents:state.teamagents };
   ...
   case ActionTypes.DELETE_TEAM_SUCCESS:
      return { ...state, ...INITIAL_STATE,myteams:state.myteams,teams : state.teams,teamerror: '', teamsuccess: 'Team deleted successfully',teamagents:state.teamagents };
    ...
    case ActionTypes.JOIN_TEAM_SUCCESS:
      return { ...state, ...INITIAL_STATE,myteams:state.myteams,teams : state.teams,teamerror: '', teamsuccess: 'Team joined successfully',teamagents:state.teamagents };
