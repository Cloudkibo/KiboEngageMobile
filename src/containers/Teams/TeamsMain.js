    ...
    return(
        <Tabs>
                <Tab
                  ...
                  onPress={() => this.changeTab('myTeams')}>
                  <MyTeams />
                </Tab>
                <Tab
                  titleStyle={{fontWeight: 'bold', fontSize: 10}}
                  selectedTitleStyle={{marginTop: -1, marginBottom: 6}}
                  selected={selectedTab === 'searchTeams'}
                  title={'Search Teams'}
